...
<!--
こんにちは、かるカンです。普段はTypeScriptとReactを書いているコーヒ好きなフロントエンドエンジニアです。
-->
...
<div class="flex items-center justify-center mb-4">
<h1 class="font-bold text-green-600">大体10x faster!!</h1>
</div>
